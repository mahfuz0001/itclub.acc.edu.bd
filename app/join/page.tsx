...
export const metadata = {
  ...
  description:
    "Apply to become a member of ACC IT club - Join 200+ tech innovators building the future",
};
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 text-center">
          <h1 className="mb-4 text-4xl font-bold tracking-tight sm:text-5xl text-[#74bf45]">
            🚀 Join Adamjee Cantonment College IT Club
          </h1>
          <p className="text-lg text-[#94a3b8] mb-4">
            Transform your passion into expertise with exclusive workshops, real
            projects, and direct mentorship from industry experts.
          </p>
          ...
          <p className="text-[#94a3b8]">
            Fill out the form below to secure your spot in our exclusive
            community
          </p>
        </div>
        <JoinForm />
